...
const CONFIG = {
  pending: {
    ...
    description:
      "Your submission is in the review queue. Review typically takes 24–48 hours.",
  },
  approved: {
    bg: "bg-[#0a1f0a]",
...
export default function SubmissionStatusBanner({
  ...
  return (
    ...
    >
      {/* Icon */}
      <div
        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full border ${c.iconBg} ${c.iconBorder}`}
      >
      ...
      <div className="flex flex-col gap-1">
        ...
        <p
          className="text-xs leading-relaxed text-[#777]"
          style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}
        >
          {c.description}
        </p>
